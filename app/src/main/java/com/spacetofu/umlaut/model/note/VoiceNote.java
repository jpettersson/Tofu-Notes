...
public class VoiceNote extends Note {
	...
	public VoiceNote() {
		super();
		type = Model.TYPE_VOICE_NOTE;
	}
	
	public VoiceNote(long id, long parentId, String name, String content, long createdAt,long updatedAt, long type, long priority, long reminderAt, long locationId) {
