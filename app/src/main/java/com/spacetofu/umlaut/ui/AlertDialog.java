...
public class AlertDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public AlertDialog create() {
            ...
            final AlertDialog dialog = new AlertDialog(context, R.style.ConfirmDialog);
            View layout = inflater.inflate(R.layout.alert, null);
            
            layout.findViewById(R.id.dialogFrame).setOnClickListener(new View.OnClickListener() {
